...
namespace Acme.BookStore.Web.Menus
{
    public class BookStoreMenuContributor : IMenuContributor
    {
        ...
        private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
        {
            ...
            context.Menu.Items.Insert(1, new ApplicationMenuItem("BookStore.Setting", l["Menu:Setting"], "~/").AddItem(new ApplicationMenuItem(
                        name: "BookStore.Setting.Profile",
                        displayName: l["Setting:Profile"],
                        url: "/crm/customers")
                    ).AddItem(new ApplicationMenuItem(
                        name: "BookStore.Setting.Address",
                        displayName: l["Setting:Address"],
                        url: "/crm/orders")
                     )
                );
